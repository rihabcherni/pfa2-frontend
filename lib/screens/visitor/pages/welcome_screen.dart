...
//                         child: Text(
//                           'Welcome to Nawerny E-Learning application, a platform designed to provide educational resources for people with disabilities. Our goal is to make learning accessible and inclusive for everyone.',
//                           style: TextStyle(
//                           ),
//                         ),
//                       ),
...
//                       ),
//                       Material(
//                         color: const Color.fromARGB(255, 2, 44, 141),
//                         borderRadius: BorderRadius.circular(10),
//                         child: InkWell(
//                           onTap: () {
//                             Navigator.of(context).pushNamed('/all-courses');
